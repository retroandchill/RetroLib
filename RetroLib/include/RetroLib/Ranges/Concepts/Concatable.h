...
namespace retro::ranges {
     ...
     */
    template<typename... R>
    concept ConcatIndirectlyReadable = std::common_reference_with<ConcatReference<R...> &&,
                                           ConcatValue<R...> &> &&
                                       std::common_reference_with<ConcatReference<R...> &&,
                                           ConcatRValueReference<R...> &&> &&
                                       std::common_reference_with<ConcatRValueReference<R...> &&,
                                           ConcatValue<R...> const &> &&
                                       (ConcatIndirectlyReadableImpl<ConcatReference<R...>,
                                           ConcatRValueReference<R...>,
